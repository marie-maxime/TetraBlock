...
TetraBloc.FinJeu.prototype = {
  ...
  create: function () {
    ...
    //Le texte
    var laPolice2 =
      "bold " + Math.round(32 * TetraBloc.RATIO_ECRAN.moyen) + "px Arial";
    var style2 = {
      font: laPolice2,
      fill: "#FFFFFF",
      align: "center",
    ...
    var finJeuTxt = this.game.add.text(
      this.game.width / 2,
      this.game.height / 3,
      leTexte,
      style2
    ...
    //Bouton
    var boutonJouer = this.game.add.button(
      this.game.width / 2,
      this.game.height / 1.75,
      "jouerBtn",
      this.rejouer,
      this,
      1,
    ...
    boutonJouer.scale.set(
      TetraBloc.RATIO_ECRAN.moyen,
      TetraBloc.RATIO_ECRAN.moyen
    );

    var laPolice3 =
      "bold " + Math.round(18 * TetraBloc.RATIO_ECRAN.moyen) + "px Arial";
    var style3 = {
      font: laPolice3,
      fill: "#DDDDDD",
      align: "center",
    ...
    switch (TetraBloc.mode) {
      case 0:
        if (
          ...
          localStorage.TetraBlocInfini == null
        ) {
          localStorage.TetraBlocInfini = this.score;
        }
      ...
      case 1:
        if (
          ...
          localStorage.TetraBlocSurvie == null
        ) {
          localStorage.TetraBlocSurvie = this.score;
        }
      ...
      case 2:
        if (
          ...
          localStorage.TetraBlocExtreme == null
        ) {
          localStorage.TetraBlocExtreme = this.score;
        }
