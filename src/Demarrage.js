  ...
  init: function () {
    ...
    if (!this.game.device.desktop) {
      ...
      TetraBloc.RATIO_ECRAN.horizontal =
        this.game.width / TetraBloc.RATIO_ECRAN.LARGEUR;
      TetraBloc.RATIO_ECRAN.vertical =
        this.game.height / TetraBloc.RATIO_ECRAN.HAUTEUR;
      TetraBloc.RATIO_ECRAN.moyen =
        (TetraBloc.RATIO_ECRAN.horizontal + TetraBloc.RATIO_ECRAN.vertical) / 2;
      TetraBloc.RATIO_ECRAN.minimum = Math.min(
        TetraBloc.RATIO_ECRAN.horizontal,
        TetraBloc.RATIO_ECRAN.vertical
      );
    }
