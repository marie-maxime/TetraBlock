...
TetraBloc.ChargementMedias.prototype = {
  init: function () {
    ...
    this.rondelle = this.game.add.sprite(
      this.game.width / 2,
      this.game.height / 4,
      leGraphique.generateTexture()
    );
    this.rondelle.anchor.set(0.5);
    this.rondelle.scale.set(
      TetraBloc.RATIO_ECRAN.moyen,
      TetraBloc.RATIO_ECRAN.moyen
    );
    //Créer et afficher le texte
    this.pourcentTxt = this.game.add.text(
      this.game.width / 2,
      this.game.height / 2,
      "0 %",
      {
  ...
  preload: function () {
    ...
    this.game.load.spritesheet(
      "jouerBtn",
      "medias/img/bouton-jouer.png",
      360,
      80
    );
    this.game.load.spritesheet(
      "modeBtn",
      "medias/img/boutons-modes.jpg",
      360,
      70
    );
    this.game.load.spritesheet(
      "flecheBtn",
      "medias/img/boutons-fleches.png",
      100,
      100
    );
    ...
    this.game.load.spritesheet(
      "bloc",
      "medias/img/spritesheet_blocs.png",
      TetraBloc.TAILLE_IMG,
      TetraBloc.TAILLE_IMG
    );
    this.game.load.spritesheet(
      "blocAnim",
      "medias/img/sprite_animationBloc.png",
      107.97,
      145
    );

    //Charger les sons
    this.game.load.audio("clique", [
      "medias/sons/clique.mp3",
      "medias/sons/clique.ogg",
    ]);
    this.game.load.audio("pop", ["medias/sons/pop.mp3", "medias/sons/pop.ogg"]);
    this.game.load.audio("niveau", [
      "medias/sons/niveau.mp3",
      "medias/sons/niveau.ogg",
    ]);
    this.game.load.audio("musique", [
      "medias/sons/musique.mp3",
      "medias/sons/musique.ogg",
    ]);
