...
(function() { //IFFE
    ...
    var AnimEtoile = function AnimEtoile(pJeu, pPosX, pPosY, pCouleurLigne, pCouleur) {
        ...
        Phaser.Sprite.call(this, this.leJeu, this.posX, this.posY, uneEtoile.generateTexture());

        //animer l'étoile
        this.anchor.set(0.5);
        this.scale.set(TetraBloc.RATIO_ECRAN.horizontal,TetraBloc.RATIO_ECRAN.vertical);
        this.animerEtoile();
    ...
    AnimEtoile.prototype.animerEtoile = function() {
        ...
        }, 500, Phaser.Easing.Elastic.InOut, true);
