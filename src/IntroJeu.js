...
TetraBloc.IntroJeu.prototype = {
  create: function () {
    ...
    //Image de l'intro
    var animBloc = this.game.add.sprite(
      -this.game.width / 2,
    ...
    animBloc.scale.setTo(
      TetraBloc.RATIO_ECRAN.moyen * 2,
      TetraBloc.RATIO_ECRAN.moyen * 2
    );
  ...
  afficherTxt: function () {
    var laPolice =
      Math.round(36 * TetraBloc.RATIO_ECRAN.moyen) + "px Monospace";
    var leTexte = this.game.add.text(
      this.game.width / 2,
      this.game.height / 1.2,
      "Cliquer dans l'écran\npour jouer",
      {
        font: laPolice,
        fill: "#FFF",
        align: "center",
