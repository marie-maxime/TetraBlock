...
TetraBloc.Instruction.prototype = {
  ...
  create: function () {
    ...
    //Le titre
    var laPolice1 =
      "bold " + Math.round(64 * TetraBloc.RATIO_ECRAN.moyen) + "px Arial";
    var style1 = {
      font: laPolice1,
      fill: "#FFFFFF",
      align: "center",
    ...
    //Le texte
    var laPolice2 =
      Math.round(25 * TetraBloc.RATIO_ECRAN.moyen) + "px Monospace";
    ...
    var laPolice3 =
      "bold " + Math.round(36 * TetraBloc.RATIO_ECRAN.moyen) + "px Monospace";
    ...
    boutonRapide.scale.set(
      TetraBloc.RATIO_ECRAN.moyen,
      TetraBloc.RATIO_ECRAN.moyen
    );

    var instructionMode = this.game.add.text(
      this.game.width / 2,
      this.game.height / 1.5,
      "Faire le plus de points en 3 minutes",
      {
        font: laPolice4,
        fill: "lightgray",
        align: "left",
    ...
    var boutonSurvie = this.game.add.button(
      this.game.width / 2,
      this.game.height / 1.325,
      "modeBtn",
      this.jouerSurvie,
      this,
      1,
    ...
    var instructionMode = this.game.add.text(
      this.game.width / 2,
      this.game.height / 1.22,
      "Survivre pendant 15 niveaux",
      {
        font: laPolice4,
        fill: "lightgray",
        align: "left",
    ...
    var boutonExtreme = this.game.add.button(
      this.game.width / 2,
      this.game.height / 1.11,
      "modeBtn",
      this.jouerExtreme,
      this,
      2,
    ...
    var instructionMode = this.game.add.text(
      this.game.width / 2,
      this.game.height / 1.03,
      "Survivre 15 niveau, pour les experts du jeu",
      {
        font: laPolice4,
        fill: "lightgray",
        align: "left",
